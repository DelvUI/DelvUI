...
namespace DelvUI
{
    public class PluginConfiguration : IPluginConfiguration
    {
        ...
        public void Save() {
            ...
            if (ConfigChangedEvent != null) ConfigChangedEvent(this, null);
        }
        ...
        public void BuildColorMap() {
            JobColorMap = new Dictionary<uint, Dictionary<string, uint>>
            {
                ...
                [Jobs.MNK * 1000] = new() // Scholar Empty Bar Color
                {
                ...
                [Jobs.MNK * 1000 + 1] = new() // Scholar Empty Bar Color
                {
                ...
                [Jobs.MNK * 1000 + 2] = new() // Scholar Empty Bar Color
                {
                ...
                [Jobs.MNK * 1000 + 3] = new() // Scholar Empty Bar Color
                {
                ...
                [Jobs.BLM * 1000] = new() // Mana Bar no element
                {
                ...
                [Jobs.BLM * 1000 + 1] = new() // Mana bar ice
                {
                ...
                [Jobs.BLM * 1000 + 2] = new() // Mana bar fire
                {
                ...
                [Jobs.BLM * 1000 + 3] = new() // Umbral heart
                {
                ...
                [Jobs.BLM * 1000 + 5] = new() // Triplecast
                {
                ...
                [Jobs.BLM * 1000 + 6] = new() // Firestarter
                {
                ...
                [Jobs.BLM * 1000 + 7] = new() // Thundercloud
                {
        ...
        public Vector4 WAREmptyColor = new(143f / 255f, 141f / 255f, 142f / 255f, 100f / 100f);
        ...
        public Vector4 SchEmptyColor = new(0f / 255f, 0f / 255f, 0f / 255f, 53f / 100f);
        ...
        public Vector4 WhmEmptyColor = new(0f, 0f, 0f, 136f / 255f);
        ...
        public Vector4 SmnEmptyColor = new(0f / 255f, 0f / 255f, 0f / 255f, 136f / 255f);
        ...
        public Vector4 SamEmptyColor = new(0f / 255f, 0f / 255f, 0f / 255f, 136f / 255f);
        ...
        public Vector4 MCHEmptyColor = new(143f / 255f, 141f / 255f, 142f / 255f, 100f / 100f);
        ...
        public Vector4 DRKEmptyColor = new(143f / 255f, 141f / 255f, 142f / 255f, 100f / 100f);
        ...
        public Vector4 PLDEmptyColor = new(143f / 255f, 141f / 255f, 142f / 255f, 100f / 100f);
        ...
        public Vector4 MNKDemolishColor = new(147f / 255f, 0f, 83f / 255f, 100f);
        public Vector4 MNKChakraColor = new(204f / 255f, 115f / 255f, 0f, 100f);
        public Vector4 MNKLeadenFistColor = new(255f / 255f, 234f / 255f, 0f, 100f);
        public Vector4 MNKTwinSnakesColor = new(121f / 255f, 0f, 96f / 255f, 100f);
        ...
        public Vector4 BLMManaBarNoElementColor = new(234f / 255f, 95f / 255f, 155f / 255f, 100f / 100f);
        public Vector4 BLMManaBarIceColor = new(69f / 255f, 115f / 255f, 202f / 255f, 100f / 100f);
        public Vector4 BLMManaBarFireColor = new(204f / 255f, 40f / 255f, 40f / 255f, 100f / 100f);
        public Vector4 BLMUmbralHeartColor = new(125f / 255f, 195f / 255f, 205f / 255f, 100f / 100f);
        public Vector4 BLMPolyglotColor = new(234f / 255f, 95f / 255f, 155f / 255f, 100f / 100f);
        public Vector4 BLMTriplecastColor = new(255f / 255f, 255f / 255f, 255f / 255f, 100f / 100f);
        public Vector4 BLMFirestarterColor = new(255f / 255f, 136f / 255f, 0 / 255f, 90f / 100f);
        public Vector4 BLMThundercloudColor = new(240f / 255f, 163f / 255f, 255f / 255f, 90f / 100f);
        public Vector4 BLMDotColor = new(67f / 255f, 187 / 255f, 255f / 255f, 90f / 100f);
        ...
        public Vector4 RDMManaBarColor = new(234f / 255f, 95f / 255f, 155f / 255f, 100f / 100f);
        public Vector4 RDMManaBarBelowThresholdColor = new(69f / 255f, 115f / 255f, 202f / 255f, 100f / 100f);
