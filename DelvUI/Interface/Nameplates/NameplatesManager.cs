...
namespace DelvUI.Interface.Nameplates
{
    ...
    public struct NameplateData
    {
        ...
        public NameplateData(GameObject? gameObject, string name, string title, bool isTitlePrefix, bool isTitleOriginal, Vector3 honorificTitleColor, Vector3 honorificTitleGlow, int namePlateIconId, string order, ObjectKind kind, byte subKind, Vector2 screenPosition, Vector3 worldPosition, float distance, bool ignoreOcclusion = false)
        {
