    ...
    public class ScholarHudWindow : HudWindow {
        ...
        private void DrawFairyBar() {
            ...
            drawList.AddRectFilledMultiColor(
                cursorPos,
                cursorPos + new Vector2(BarSize.X * gauge / 100, BarSize.Y),
                SchFairyColor["gradientLeft"],
                SchFairyColor["gradientRight"],
                SchFairyColor["gradientRight"],
                SchFairyColor["gradientLeft"]
            );
            ...
            DrawOutlinedText(
                gauge.ToString(CultureInfo.InvariantCulture),
                new Vector2(
                    cursorPos.X
                  + BarSize.X * gauge / 100
                  - (gauge == 100
        ...
        private void DrawBioBar() {
            ...
            DrawOutlinedText(
                bioDuration.ToString(CultureInfo.InvariantCulture),
                new Vector2(
                    cursorPos.X
                  + BarSize.X * bioDuration / 30
                  - (bioDuration == 30
                        ? 30
                        : bioDuration > 3
                            ? 20
