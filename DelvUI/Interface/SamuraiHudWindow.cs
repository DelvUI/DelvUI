    ...
    public class SamuraiHudWindow : HudWindow
    {
        ...
        private void DrawKenkiBar()
        {
            ...
            drawList.AddRectFilledMultiColor(
                cursorPos,
                cursorPos + new Vector2(SamKenkiBarWidth * scale, SamKenkiBarHeight),
                SamKenkiColor["gradientLeft"],
                SamKenkiColor["gradientRight"],
                SamKenkiColor["gradientRight"],
                SamKenkiColor["gradientRight"]
            );
        ...
        private void DrawActiveBuffs()
        {
            ...
            if (!PluginConfiguration.ShowBuffTime)
            {
                ...
                drawList.AddRectFilledMultiColor(
                    cursorPos,
                    cursorPos + new Vector2(barSize.X / 30 * jinpuDuration, barSize.Y),
            ...
            else
            {
                ...
                drawList.AddRectFilledMultiColor(
                    cursorPos,
                    cursorPos + new Vector2(barSize.X / 40 * jinpuDuration, barSize.Y),
                    jinpuDuration > 0 ? SamJinpuColor["gradientLeft"] : 0x00202E3,
                    jinpuDuration > 0 ? SamJinpuColor["gradientRight"] : 0x00202E3,
                    jinpuDuration > 0 ? SamJinpuColor["gradientRight"] : 0x00202E3,
                    jinpuDuration > 0 ? SamJinpuColor["gradientLeft"] : 0x00202E3
