    ...
    public class BardHudWindow : HudWindow
    {
        ...
        private void DrawActiveDots()
        {
            ...
            if (_config.ShowCB) {
                ...
                Bar cbBar = builder.AddInnerBar(duration, 30f, color.Map)
            ...
            if (_config.ShowSB) {
                ...
                Bar sbBar = builder.AddInnerBar(duration, 30f, color.Map)
        ...
        private void DrawSoulVoiceBar()
        {
            ...
            Bar bar = builder.AddInnerBar(soulVoice, 100f, _config.SoulGaugeColor.Map)
                             .SetBackgroundColor(EmptyColor["background"])
                             .Build();
