...
namespace DelvUI.Interface
{
    public class ConfigurationWindow
    {
        ...
        public void Draw() {
            ...
            if (!ImGui.Begin("DelvUI configuration", ref IsVisible, ImGuiWindowFlags.NoCollapse)) return;
            ...
            if (ImGui.BeginTabBar("##settings-tabs")) {
                ...
                if (ImGui.BeginTabItem("Paladin")) {
                    ...
                    var pldInterBarOffset = _pluginConfiguration.PLDInterBarOffset;
                ...
                if (ImGui.BeginTabItem("Black Mage")) {
                    ...
                    changed |= ImGui.Checkbox(
                        "Show Mana Threshold Marker During Astral Fire",
                    ...
                    changed |= ImGui.ColorEdit4(
                        "Firestarter Proc Color",
                        ref _pluginConfiguration.BLMFirestarterColor
                    );

                    changed |= ImGui.ColorEdit4(
                        "Thundercloud Proc Color",
