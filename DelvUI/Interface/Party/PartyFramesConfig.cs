...
namespace DelvUI.Interface.Party
{
    ...
    public class PartyFramesColorsConfig : PluginConfigObject
    {
        ...
        [Order(45, collapseWith = nameof(UseRoleColors))]
        ...
        [Order(55, collapseWith = nameof(ShowHighlight))]
        ...
        [Order(70, collapseWith = nameof(ShowEnmityBorderColors))]
        ...
        [Order(80, collapseWith = nameof(ShowSecondEnmity))]
