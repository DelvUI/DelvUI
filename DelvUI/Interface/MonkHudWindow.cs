...
namespace DelvUI.Interface
{
    public class MonkHudWindow : HudWindow
    {
        ...
        private void Demolish() {
            ...
            if (PluginConfiguration.ShowDemolishTime) DrawOutlinedText(Math.Round(demolishDuration).ToString(CultureInfo.InvariantCulture), new Vector2(demoXOffset, demoYOffset));
        }
