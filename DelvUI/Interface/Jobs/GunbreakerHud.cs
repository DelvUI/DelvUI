...
namespace DelvUI.Interface.Jobs
{
    public class GunbreakerHud : JobHud
    {
        ...
        private void DrawPowderGauge(Vector2 pos)
        {
            ...
            {
                BarUtilities.GetChunkedProgressBars(nameof(Config.PowderGauge), Config.PowderGauge, 2, gauge.Ammo, 2).Draw(pos);
            }
        }
        ...
        private void DrawNoMercyBar(Vector2 pos, PlayerCharacter player)
        {
            ...
            if (!Config.NoMercy.HideWhenInactive || noMercyDuration > 0)
            {
                ...
                BarUtilities.GetProgressBar(nameof(Config.NoMercy), Config.NoMercy, noMercyDuration, 20f, 0f, player).Draw(pos);
            }
        }
    }
