        ...
        private void DrawJobsTankConfig()
        {
            if (ImGui.BeginTabBar("##tanks-tabs")) {
                ...
                if (ImGui.BeginTabItem("Warrior")) {
                    ...
                    _changed |= ImGui.ColorEdit4("Nascent Chaos Ready Color", ref _pluginConfiguration.WARNascentChaosColor);
                ...
                if (ImGui.BeginTabItem("Paladin")) {
                    ...
                    _changed |= ImGui.ColorEdit4("Fight or Flight Color", ref _pluginConfiguration.PLDFightOrFlightColor);
