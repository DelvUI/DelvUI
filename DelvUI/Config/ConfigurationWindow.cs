        ...
        private void DrawJobsTankConfig()
        {
            if (ImGui.BeginTabBar("##tanks-tabs"))
            {
                ...
                if (ImGui.BeginTabItem("Paladin"))
                {
                    ...
                    var pldManaEnabled = _pluginConfiguration.PLDManaEnabled;
                    ...
                    var pldManaChunked = _pluginConfiguration.PLDManaChunked;
                    ...
                    var pldManaBarText = _pluginConfiguration.PLDManaBarText;
                    ...
                    var pldManaHeight = _pluginConfiguration.PLDManaHeight;
                    ...
                    var pldManaWidth = _pluginConfiguration.PLDManaWidth;
                    ...
                    var pldManaPadding = _pluginConfiguration.PLDManaPadding;
                    ...
                    var pldManaXoffset = _pluginConfiguration.PLDManaXOffset;
                    ...
                    var pldManaYoffset = _pluginConfiguration.PLDManaYOffset;
                    ...
                    var pldOathGauge = _pluginConfiguration.PLDOathGaugeEnabled;
                    ...
                    var oathGaugeText = _pluginConfiguration.PLDOathGaugeText;
                    ...
                    var pldOathGaugeHeight = _pluginConfiguration.PLDOathGaugeHeight;
                    ...
                    var pldOathGaugeWidth = _pluginConfiguration.PLDOathGaugeWidth;
                    ...
                    var oathGaugePadding = _pluginConfiguration.PLDOathGaugePadding;
                    ...
                    var oathGaugeXoffset = _pluginConfiguration.PLDOathGaugeXOffset;
                    ...
                    var oathGaugeYoffset = _pluginConfiguration.PLDOathGaugeYOffset;
                    ...
                    var buffBarEnabled = _pluginConfiguration.PLDBuffBarEnabled;
                    ...
                    var buffBarText = _pluginConfiguration.PLDBuffBarText;
                    ...
                    var pldBuffBarHeight = _pluginConfiguration.PLDBuffBarHeight;
                    ...
                    var pldBuffBarWidth = _pluginConfiguration.PLDBuffBarWidth;
                    ...
                    var pldBuffBarXoffset = _pluginConfiguration.PLDBuffBarXOffset;
                    ...
                    var pldBuffBarYoffset = _pluginConfiguration.PLDBuffBarYOffset;
                    ...
                    var atonementBarEnabled = _pluginConfiguration.PLDAtonementBarEnabled;
                    ...
                    var pldAtonementBarHeight = _pluginConfiguration.PLDAtonementBarHeight;
                    ...
                    var pldAtonementBarWidth = _pluginConfiguration.PLDAtonementBarWidth;
                    ...
                    var pldAtonementBarXoffset = _pluginConfiguration.PLDAtonementBarXOffset;
                    ...
                    var pldAtonementBarYoffset = _pluginConfiguration.PLDAtonementBarYOffset;
                    ...
                    var pldAtonementBarPadding = _pluginConfiguration.PLDAtonementBarPadding;
                    ...
                    var pldDoTBar = _pluginConfiguration.PLDDoTBarEnabled;
                    ...
                    var pldDoTBarText = _pluginConfiguration.PLDDoTBarText;
                    ...
                    var pldDoTBarHeight = _pluginConfiguration.PLDDoTBarHeight;
                    ...
                    var pldDoTBarWidth = _pluginConfiguration.PLDDoTBarWidth;
                    ...
                    var dotBarXoffset = _pluginConfiguration.PLDDoTBarXOffset;
                    ...
                    var dotBarYoffset = _pluginConfiguration.PLDDoTBarYOffset;
        ...
        private void DrawJobsHealerConfig()
        {
            if (ImGui.BeginTabBar("##HEALERS-tabs"))
            {
                if (ImGui.BeginTabItem("Scholar"))
                {
                    ...
                    _changed |= ImGui.Checkbox(
                        "Show Primary Resource Bar",
        ...
        private void DrawJobsMeleeConfig()
        {
            if (ImGui.BeginTabBar("##melee-tabs"))
            {
                if (ImGui.BeginTabItem("Samurai"))
                {
                    ...
                    if (ImGui.CollapsingHeader("Base Offset"))
                    {
                    ...
                    if (ImGui.CollapsingHeader("Higanbana Bar"))
                    {
                    ...
                    if (ImGui.CollapsingHeader("Shifu/Jinpu Bar"))
                    {
                        ...
                        var samBuffOrder = _pluginConfiguration.SAMBuffOrder;

                        if (ImGui.Checkbox("Jinpu First", ref samBuffOrder))
                        {
                            _pluginConfiguration.SAMBuffOrder = samBuffOrder;
                            _pluginConfiguration.Save();
                        }
                    ...
                    if (ImGui.CollapsingHeader("Kenki Bar"))
                    {
                    ...
                    if (ImGui.CollapsingHeader("Sen Bar"))
                    {
                        ...
                        string[] orderStrings = { "Setsu Getsu Ka", "Setsu Ka Getsu", "Getsu Setsu Ka", "Getsu Ka Setsu", "Ka Setsu Getsu", "Ka Getsu Setsu" };
                        List<string> orderList = new List<string>(orderStrings);
                        var selection = Math.Max(0, orderList.IndexOf(_pluginConfiguration.SAMSenOrder));
                        if (ImGui.Combo("Sen Order", ref selection, orderStrings, 6))
                        {
                            _pluginConfiguration.SAMSenOrder = orderList[selection];
                            _pluginConfiguration.Save();
                        }
                    }

                    if (ImGui.CollapsingHeader("Meditation Bar"))
                    {
