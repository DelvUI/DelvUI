...
namespace DelvUI.Helpers
{
    public static class LayoutHelper
    {
        ...
        public static void CalculateLayout(Vector2 maxSize, Vector2 itemSize, uint count, int horizontalPadding, int verticalPadding, bool fillRowsFirst, out uint rowCount, out uint colCount)
        {
            rowCount = 1;
            colCount = 1;
