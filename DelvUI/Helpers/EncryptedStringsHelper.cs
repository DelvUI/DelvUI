...
namespace DelvUI.Helpers
{
    public static class EncryptedStringsHelper
    {
        ...
        {
            [9259] = new string[] { "グランドクロス・アルファ", "Grand Cross Alpha", "Supernova Alpha", "Croix suprême alpha", "大十字·阿尔法" },
            [9260] = new string[] { "グランドクロス・デルタ", "Grand Cross Delta", "Supernova Delta", "Croix suprême delta", "大十字·德尔塔" },
            [9261] = new string[] { "グランドクロス・オメガ", "Grand Cross Omega", "Supernova Omega", "Croix suprême oméga", "大十字·欧米茄" },
            [27174] = new string[] { "近思の魔撃", "Nearsight", "Blick nach Innen", "Frappe introspective", "近思的魔击" },
            [27175] = new string[] { "遠見の魔撃", "Farsight", "Blick in die Ferne", "Frappe visionnaire", "远见的魔击" },
            ...
            [28280] = new string[] { "半神の双撃", "Demigod Double", "Hemitheischer Hieb", "Gémellité du demi-dieu", "半神双击" },
        ...
        {
            [1379] = new string[] { "アルマゲスト", "Almagest", "Almagest", "Almageste", "至高无上" },
            ...
            [2800] = new string[] { "腐呪のクラミュス", "Casting Chlamys", "Faulende Chlamys", "Chlamyde maudite", "腐咒斗篷" },
            [2801] = new string[] { "属性耐性低下", "Elemental Resistance Down", "Resistenz -", "Résistance élémentaire réduite", "属性耐性降低" },
            [2802] = new string[] { "三役の腐呪", "Role Call", "Dreifäulenoper", "Rôle tragique", "职能腐咒" },
            [2803] = new string[] { "三役の抗呪", "Miscast", "Zwischenakt", "Résistance tragique", "职能抗咒" },
            [2804] = new string[] { "エーテルソーン", "Thornpricked", "Ätherdorn", "Épines d'éther", "以太荆棘" },
            ...
            [2925] = new string[] { "攻手の魔呪", "Acting DPS", "Fluch des Schmerzes", "Malédiction des attaquants", "进攻手的魔咒" },
            [2926] = new string[] { "癒手の魔呪", "Acting Healer", "Fluch des Lebens", "Malédiction des guérisseurs", "治疗手的魔咒" },
            [2927] = new string[] { "守手の魔呪", "Acting Tank", "Fluch des Schutzes", "Malédiction des protecteurs", "防护手的魔咒" },
            [2977] = new string[] { "被回復低下", "HP Recovery Down", "Heilung -", "Soins diminués", "治疗效果降低" },
            [2978] = new string[] { "被回復低下", "HP Recovery Down", "Heilung -", "Soins diminués", "治疗效果降低" }
        };

        private static Dictionary<uint, string[]> StatusDescriptionMap = new Dictionary<uint, string[]>()
        {
            [1379] = new string[] { "天体魔法を受けた状態。ＨＰが徐々に失われる。", "Celestial magicks are causing damage over time.", "Erleidet schrittweise Schaden durch außerweltliche Magie.", "Sous l'effet d'une magie astrale. Des dégâts périodiques sont subis.", "受到天体魔法影响，体力逐渐减少" },
